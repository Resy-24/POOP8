...
public class Triangulo extends Poligono{
     ...
     * @return Devuelve el area del triangulo al multiplicar su base por su altura
     */
    @Override
    public float area(){
    ...
    /**
     * Metodo perimetro del triangulo
     * @return Devuelve el perimetro del triangulo al sumar el lado a mas el lado b mas el lado c
     */
    @Override
